...
// License: MIT-license
// Modified by Julien Lafont (2012)
//
(function () {
    var secret = "Hacking is for noobs";
    ...
    Store.prototype.getEncrypt = function (name) {
        name = "store." + this.name + "." + name;
        if (localStorage.getItem(name) === null) { return undefined; }
        try {
            if (key !== undefined) {
                ...
                if (obj.encrypt === true) {
                    return  Aes.Ctr.decrypt(obj.value, secret, 256);
    ...
    Store.prototype.set = function (name, value) {
     ...
     Store.prototype.setEncrypt = function (name, value) {
        var valueEncrypt = { "encrypt": true, "value": Aes.Ctr.encrypt(value, secret, 256) };
        this.set(name, valueEncrypt);
    };
